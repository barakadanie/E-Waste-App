...
public class ProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void saveUser(){
        ...
        UserDat user = new UserDat(name,school,id,currUser.getEmail(),phoneNum);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                UserDat user = dataSnapshot.child("INFO").getValue(UserDat.class);
                if (user != null){
                    editTextName.setText(user.getName());
                    editTextPhoneNum.setText(user.getPhoneNum());
                    editTextId.setText(user.getId());
                    editTextSchool.setText(user.getEmail());
